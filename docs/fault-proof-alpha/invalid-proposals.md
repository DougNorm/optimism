...
test utilities in [`op-e2e`](https://github.com/DougNorm/optimism/tree/develop/op-e2e).

A simple starting point has been provided in the `TestCannonProposedOutputRootInvalid` test case
in [`faultproof_test.go`](https://github.com/DougNorm/optimism/blob/6e174ae2b2587d9ac5e2930d7574f85d254ca8b4/op-e2e/faultproof_test.go#L334).
